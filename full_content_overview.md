...
**14:00–18:00** — Arrive whenever you can

- **Check-in:** Find the welcome table near the main entrance
- **You'll get:** Your room assignment, welcome packet with map, meal schedule
- **Settle in:** Go to your room, meet your roommates, arrange your bunk
- **Find the energy:** Explore common areas, grab a coffee, chat with early arrivals

**18:00–19:00** — Build Day (optional but magical)

- Hang lights, arrange lounge areas, set up the space
- Meet people while working side-by-side
- No skills needed — just hands and heart
- Most people who arrive early say this is when the magic starts

**19:00–20:00** — First Meal Together

- Dinner is communal — we all eat in the main space
- Find a seat, meet neighbors, shake off the outside world
- This meal is warm, filling, made with care

**20:30–21:00** — Settling In

- Return to your room, get comfortable
- Use the bathroom, brush your teeth, get ready
- Chat quietly with roommates
- The energy is building

---

## Wednesday Evening – Opening Circle

**21:00** — Opening Circle (Required)
...
**BUT:** You have options (see [Ticket Transfers & Resale](/practical/ticket-transfers) for alternatives).
...
See [Ticket Transfers & Resale](/practical/ticket-transfers) for how to resell, defer, or request exceptions.
...
**About the policy?** Email [info@roguerope.be](mailto:info@roguerope.be)

**Want to resell or defer?** See [Ticket Transfers & Resale](/practical/ticket-transfers)
...
- **Designed to last** (quality stitching, durable materials)
...
- Recycle when it's truly at end-of-life
...
- **A memory** (every time you wear it)
...
We'll try to accommodate. No guarantees, but we listen.
...
- **Bank transfer** (if ordering early)
...
(Previous year designs may be available if stock exists — ask at the event or email us.)

**Want to trade or swap past year shirts?**

Join the WhatsApp community — people trade shirts all the time.
...
**Email [info@roguerope.be](mailto:info@roguerope.be) for shipping quotes.**

---

## FAQs

### When can I see designs?

Design details are shared as we get closer to the event. Check your email and the WhatsApp community for announcements.

### Are there kids' sizes?

Not at this time (this is an adult event). But if you need sizes outside our range, reach out.
...
Possibly. Live design or artist collaboration TBD.

### What if my shirt doesn't fit?

**Returns/exchanges possible** within [X days] of the event. Contact [info@roguerope.be](mailto:info@roguerope.be).

---

## Questions?

**About sizing or care?** Email [info@roguerope.be](mailto:info@roguerope.be)

**Ready to order?** See [Merchandise](/practical/merchandise) for ordering details.
...
<div class="hx-bg-blue-50 dark:hx-bg-blue-900/20 hx-p-6 hx-rounded-lg hx-mb-8">
...
<div class="hx-bg-green-50 dark:hx-bg-green-900/20 hx-p-6 hx-rounded-lg hx-mb-8">
...
<div class="hx-bg-purple-50 dark:hx-bg-purple-900/20 hx-p-6 hx-rounded-lg hx-mb-8">
...
<div class="hx-bg-gradient-to-r hx-from-rose-50 hx-to-pink-50 dark:hx-from-rose-900/20 dark:hx-to-pink-900/20 hx-p-8 hx-rounded-lg hx-mb-8">
...
<div class="hx-bg-gradient-to-r hx-from-teal-50 hx-to-cyan-50 dark:hx-from-teal-900/20 dark:hx-to-cyan-900/20 hx-p-8 hx-rounded-lg hx-mb-8">
...
<div class="hx-bg-gray-50 dark:hx-bg-gray-800/30 hx-p-6 hx-rounded-lg hx-mb-8">
...
<div class="hx-bg-indigo-50 dark:hx-bg-indigo-900/20 hx-p-6 hx-rounded-lg hx-mb-8">
...
<div class="hx-text-center hx-py-8 hx-bg-gradient-to-r hx-from-yellow-50 hx-to-amber-50 dark:hx-from-yellow-900/10 dark:hx-to-amber-900/10 hx-rounded-lg">
...
<div class="hx-bg-gradient-to-r hx-from-pink-50 hx-to-rose-50 dark:hx-from-pink-900/20 dark:hx-to-rose-900/20 hx-p-8 hx-rounded-lg hx-text-center">

## What's next?

Before you arrive, explore our care and support resources to prepare for this transformative experience.

<div class="hx-mt-6">
<a href="/wellbeing" class="hx-inline-flex hx-items-center hx-px-6 hx-py-3 hx-bg-pink-600 hx-text-white hx-text-lg hx-rounded-lg hover:hx-bg-pink-700 hx-transition-colors">
  Care & Support →
</a>
</div>

<div class="hx-mt-4 hx-text-sm text-outer-space">
Or explore: <a href="/contact" class="hx-underline hover:hx-no-underline">Contact Us</a> • <a href="/concept" class="hx-underline hover:hx-no-underline">Back to Experience</a>
</div>
...
![An intimate, non-performative rope scene happening organically in a communal space.](/images/rrc25/performance.png)
...
- Allow third-party photography
- Force anyone into frames

**Your body, your image, your choice.**
...
1. **Wear a "no photos" indicator** (badge or armband — provided at check-in)
2. **Tell photographers directly:** "I prefer not to be photographed"
3. **Opt out during consent moment:** We'll ask who opts out; you'll be noted
4. **Tell Consent Crew:** They can spread the word

**Photographers respect these choices immediately.**
...
We'll delete them within 48 hours. No questions asked. No judgment.

---

### If You're in a Photo You Didn't Consent To

**This is a violation. We take it seriously.**

1. **Report it immediately** to [info@roguerope.be](mailto:info@roguerope.be) or a Consent Crew member
2. **The photo is removed immediately**
3. **We address it with the photographer**
4. **This is a boundary violation** — we take accountability seriously
...
**About photography guidelines?** Email [info@roguerope.be](mailto:info@roguerope.be)

**Want to discuss before the event?** Let us know during registration.

**Changed your mind about being photographed?** Tell us anytime — before, during, or after the event.
...
Sometimes the world shifts. Sometimes you do. Plans change — work emergencies, health scares, heartbreaks, or simply the realization that you need something different right now.

We've built these policies with trust in mind — and trust goes both ways.
...
- Leave shared bathrooms tidy for the next person
...
- Please don't attend if you're feeling unwell
- Bring any medications you need
- Let us know about any health conditions that might affect your experience
- Consider your mental/emotional capacity for an intensive community experience

### During the Event

- Stay hydrated and eat regularly
- Get adequate rest between activities
- Check in with yourself regularly about your comfort and capacity
- Ask for help when you need it — that's what community is for

### Consent & Boundaries

- Consent is ongoing and can be withdrawn at any time
- "No" is a complete sentence that needs no explanation
...
- Ticket (with QR code)
- ID/Passport
- Reusable cup (no glass)

---

## Comfort (Bunk)

- Bedding (sheets, sleeping bag, blankets)
- Pillow
- Earplugs
- Sleep mask
...
- Towel
- Deodorant
- Medications (prescription + OTC painkillers/allergy meds)
...
- Comfortable layers
- Underwear + socks
- Slippers (shared floors)
- Play party outfit (anything goes)
- Warm layer
...
- Water bottle
- Favorite snacks/drinks (we provide coffee, water, meals)
- Cooler bag (optional; we provide ice)
...
Borrow it. We have extras (earplugs, sleep masks, basic toiletries, towels). Don't stress.

---

## Packing Tip

Pack a week before. Use this checklist. Leave room for things you'll return with.
...
**About resale?** Email [info@roguerope.be](mailto:info@roguerope.be)

**Want to defer?** Let us know in your email.

**Emergency situation?** Reach out — we're here to listen and work with you.

See [Cancellation & Refund Policy](/practical/cancellation-policy) for the core policy details.
...
- **Gentle guidance** for newcomers or anyone feeling lost
- **Conflict de-escalation** and helping people find appropriate resources
- **Just being a friendly face** when you need human connection

Remember: FWBs are peers, not professional counselors. We offer care within our capacity and knowledge, and we help connect people to more specialized support when needed.
...
**Drop/Crash**: After intense scenes or connections, you might experience a sudden emotional or energetic low. This is normal. Rest, hydrate, seek gentle company or quiet solitude as needed.

**Overwhelm**: Too much stimulation, too many choices, too much intensity. Find a quiet space, practice breathing, limit sensory input.

**Loneliness in Connection**: Sometimes being around many people can make you feel more alone. This paradox is real and valid. Seek one-on-one connection or comfortable solitude.

**Processing Emotions**: Experiences here can bring up unexpected feelings — old memories, new insights, complicated reactions. Let them move through you rather than trying to fix or analyze them immediately.
...
- Understanding that processing styles vary
...
- **Communication tools** (scripts for difficult conversations, clear ways to express needs)

Remember: Taking care of your neurodivergent needs isn't selfish — it's how you show up authentically for community and connection.
