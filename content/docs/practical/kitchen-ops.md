---
title: "Kitchen & Food Ops"
description: "Kitchen planning reference and dietary guide for RRC26 — not linked from site navigation."
lead: "For kitchen crew (planning, staffing, order files) and for guests checking dietary/allergen needs — not linked from site navigation, share the direct link."
...
Vera coordinates food for RRC26. Her spreadsheet ["RRC2026 v2"](https://docs.google.com/spreadsheets/d/1lXdCtYhYNms5FyHrUBbxSOwQMqOo8mN5iqTA1LbeIOY) is the live source of truth — this page mirrors it (pulled 2026-07-18) for reference. If anything here looks stale, check her sheet first.
...
- [Tuesday order (Pasta)](/files/rrc26-food/rrc26-tuesday-full-order.csv)
