...
**Please**, if you have had issues with someone, seen red flags, witnessed inapropriate behavior of someone on the 'going-list', **let us know**.
You can use fl messages or [contact the orga]({{< ref "/docs/main/contact" >}} "Contact us") in some other way. 
Feel free to use an pseudonymous account by creating a new mailaddres with protonmail/yahoo/fastmail/...
Please describe the issues and propose a way for us to deal with it. Does this person need someone to work with them on their behavior? Could we assist in facilitating with [restorative justice](https://en.wikipedia.org/wiki/Restorative_justice)? Can they still attend but do we need to keep an eye on them? Can they attend if they promise not to interact with you? Or is the best solution for them not to attend the event? 

We will assess the situation and try to think of the best solution, after wich we will contact you to see if this solution works for you. No process is perfect, but we'll try to find something that's best for all involved parties.
