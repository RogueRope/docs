...
### TinaCMS Integration
- **TinaCMS CLI**: Available via `@tinacms/cli` for content management
- **Build with Tina**: `tinacms build && hugo --gc --minify` (when using TinaCMS)

### Dependencies
- **Install**: `npm install` (installs TinaCMS and related packages)
...
### Content Management
- **TinaCMS**: Integrated for content editing with authentication
...
- `package.json` - NPM dependencies for TinaCMS